...
return ( <main className="bg-black text-white"> <Navbar />
...
return ( <div className="rounded-2xl border border-white/10 bg-white/5 p-4"> <p className="text-xs uppercase tracking-wider text-gray-500">{label}</p>
